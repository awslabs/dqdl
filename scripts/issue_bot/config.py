...
class Config:
    def __init__(self):
        ...
        self.upstream_repo = os.getenv("UPSTREAM_REPO", "awslabs/dqdl")
        self.codebase_src_dir = os.getenv("CODEBASE_SRC_DIR", "src")
        self.codebase_file_ext = os.getenv("CODEBASE_FILE_EXT", ".java")
